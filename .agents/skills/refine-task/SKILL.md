...
After receiving the user's answers, integrate the new information into the task's file (e.g., `tasks/002.local-config.md`) to update and clarify the task description.
